...
#elif _PIN_OUT==3
// For USCTC ComE Project PCB use the following settings
struct pins {
  uint8_t dio0=26;   // GPIO5 / D1. Dio0 used for one frequency and one SF
  uint8_t dio1=34;   // GPIO4 / D2. Used for CAD, may or not be shared with DIO0
  uint8_t dio2=35;   // GPIO0 / D3. Used for frequency hopping, don't care
  uint8_t ss=5;    // GPIO15 / D8. Select pin connected to GPIO5
  uint8_t rst=25;    // GPIO0 / D3. Reset pin not used 
// Pin definetion of WIFI LoRa 32
// USC-TC Development Board
#define SCK     18   // GPIO5  -- SX127x's SCK
#define MISO    19   // GPIO19 -- SX127x's MISO
#define MOSI    23   // GPIO27 -- SX127x's MOSI
#define SS      5    // GPIO18 -- SX127x's CS
#define RST     25   // GPIO14 -- SX127x's RESET
